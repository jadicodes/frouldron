...
linux:
	mkdir -p build/linux
	godot -v --export-release "Linux/X11" ../build/linux/Frouldron.x86_64 project/project.godot

macos:
	mkdir -p build/macos
	godot -v --export-release "macOS" ../build/macos/Frouldron.dmg project/project.godot

windows:
	mkdir -p build/windows
	godot -v --export-release "Windows Desktop" ../build/windows/Frouldron.exe project/project.godot
